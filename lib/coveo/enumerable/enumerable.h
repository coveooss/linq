...
// Wrapper for aa multipass, forward-only sequence of elements.
...
public:
    ...
    private:
        ...
        static pointer get_copied_pcur(std::unique_ptr<T>& our_upopt,
...
template<typename U> // #clp TODO continue HERE!
