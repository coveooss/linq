...
void linq_tests()
{
    ...
    // first_or_default
    {
        ...
        using namespace coveo::linq;
        COVEO_ASSERT((from(v) >> first_or_default()) == 42);
        COVEO_ASSERT((from(e) >> first_or_default()) == 0);
        COVEO_ASSERT((from(v)
    ...
    // last_or_default
    {
        ...
        const std::vector<int> e;
        using namespace coveo::linq;
        COVEO_ASSERT((from(v) >> last_or_default()) == 24);
        COVEO_ASSERT((from(e) >> last_or_default()) == 0);
        COVEO_ASSERT((from(v)
